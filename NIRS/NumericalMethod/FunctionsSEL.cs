        ...
        public double Calc_e(double n, double k)
        {
            ...
            return _grid[n][k - 0.5].e - Step.tau *
                (
                   ...
                   + (_grid[n+0.5][k-0.5].p+_grid.q(wc,n+0.5,k-0.5))*(wc.Nabla("mS","w",n+0.5,k-0.5)+ wc.Nabla("(1-m)S", "w", n + 0.5, k - 0.5))//непонятная строчка _grid[n+0.5][k-0.5]
                   - mcn.H4(n + 0.5, k - 0.5)
                );
        }
        public double Calc_psi(double n, double k)
        {
            ...
            return _grid[n][k - 0.5].psi - Step.tau *
                (
                   ...
                   - _grid[n + 0.5][k - 0.5].psi * wc.Nabla("w", n + 0.5, k - 0.5) //непонятная строчка _grid[n + 0.5][k - 0.5]
                   - mcn.H5(n + 0.5, k - 0.5)
                );
        }
